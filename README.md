...
[![GitHub stars](https://img.shields.io/github/stars/xw9114/skill-pro)](https://github.com/xw9114/skill-pro/stargazers)
[![GitHub issues](https://img.shields.io/github/issues/xw9114/skill-pro)](https://github.com/xw9114/skill-pro/issues)
[![Last commit](https://img.shields.io/github/last-commit/xw9114/skill-pro)](https://github.com/xw9114/skill-pro/commits/main)
...
所有 Skill 统一位于 `skills/<skill-name>/`，仓库根目录只保留集合级文档和配置。
...
```powershell
git -C $collection pull
Copy-Item -Recurse -Force "$collection/skills/$skillName" "$HOME/.codex/skills/"
```

安装或更新后，新开一个 Codex 线程，让 Skills 被重新扫描。

### 调用 `readme-design-pro` 示例
...
| 资源 | 文件 |
|---|---|
| Skill 主流程 | [`skills/ppt-design-pro/SKILL.md`](./skills/ppt-design-pro/SKILL.md) |
| 页型与布局规则 | [`skills/ppt-design-pro/references/slide-playbook.md`](./skills/ppt-design-pro/references/slide-playbook.md) |
| 风格配方 | [`skills/ppt-design-pro/references/style-recipes.md`](./skills/ppt-design-pro/references/style-recipes.md) |
| QA 检查表 | [`skills/ppt-design-pro/references/qa-checklist.md`](./skills/ppt-design-pro/references/qa-checklist.md) |
| 界面元数据 | [`skills/ppt-design-pro/agents/openai.yaml`](./skills/ppt-design-pro/agents/openai.yaml) |
...
问题、改进建议和新 Skill 提案可通过 [GitHub Issues](https://github.com/xw9114/skill-pro/issues) 提交。
...
[![Star History Chart](https://api.star-history.com/svg?repos=xw9114/skill-pro&type=Date)](https://www.star-history.com/#xw9114/skill-pro&Date)

## 社区与资源

- [GitHub Issues](https://github.com/xw9114/skill-pro/issues)
- [项目仓库](https://github.com/xw9114/skill-pro)
- [提交记录](https://github.com/xw9114/skill-pro/commits/main)
